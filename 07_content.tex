...
\begin{frame}[fragile]{Pointer beliebigen Typs -- \mintinline{c}{void *}}
%
\begin{columns}[T]
\column{.5\linewidth}
%\begin{Large}
...
\begin{frame}[fragile]
%
\tcbset{width=.495\linewidth, on line, equal height group = grpXmpReallocCheck}
%
...
%
\begin{itemize}
\item \texttt{var}: unsere Verwaltungsvariable -- \enquote{die ganze Tabelle}
