...
\begin{frame}[fragile]%{structs -- \enquote{Container-Datentypen}}
%
\begin{columns}[b]
\column{.5\linewidth}
\begin{Large}
...
\begin{frame}[t,fragile]%{\texttt{struct}s und Scopes}
%
\begin{columns}[T]
\column{.4\linewidth}
\begin{Large}
...
\column{.5\linewidth}
\begin{Large}
{\mintinline{c}{enum}s -- automatisch nummerierte Symbole}
\vspace{6pt}
\end{Large}
%
\begin{itemize}
...
\column{.5\linewidth}
\begin{Large}
{\mintinline{c}{union}s -- Typecasting-Interfaces}
\vspace{6pt}
\end{Large}
%
\begin{itemize}
